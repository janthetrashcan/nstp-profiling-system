...
<body class="h-full">
  ...
  <div class="flex mt-20 h-[calc(100vh-5rem)]">
    <!-- Sidebar -->
    <aside id="sidebar"
      class="flex flex-col justify-between align-middle fixed top-16 left-0 bottom-0 w-64 bg-gray-800 text-white pt-6 pb-6 z-10 overflow-y-auto transform transition-transform duration-300">
      ...
      <div class='w-fill'>
        <div class="p-4 pt-0">
            ...
            <span class="text-md font-bold bg-gray-200 text-gray-800 rounded-full p-1 mr-3 aspect-square"><x-carbon-document-add class='h-6 m-1' /></span>
            <span class="text-md font-semibold">Import Forms</span>
            </a>
        </div>
        <div class="p-4 pt-0">
            <a
        ...
        <nav class="px-4 py-3 overflow-y-scroll w-fill">
            ...
            <div class='flex flex-col gap-2 mb-3'>
                <li class="">
                    ...
                    class="flex items-center hover:bg-blue-200 hover:bg-opacity-40 hover:text-white font-md transition-colors duration-300 rounded-lg px-2 py-1
                ...
                <li class="">
                    ...
                    class="flex items-center hover:bg-blue-200 hover:bg-opacity-40 text-sm hover:text-white transition-colors duration-300 rounded-lg px-2 py-1
