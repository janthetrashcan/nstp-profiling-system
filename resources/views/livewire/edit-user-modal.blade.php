<div class="p-7 !z-50">
    <form action="{{ route('users.update', $user) }}" method="POST">
        ...
        <div class="flex flex-col gap-y-3 justify-center items-start mb-4">
            ...
            <label for="confirmPassword">Enter your password to confirm changes</label>
