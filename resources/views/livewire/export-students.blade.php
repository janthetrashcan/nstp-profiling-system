<div class='z-50'>
    ...
    <form action='{{ route('dashboard.exportdata') }}' class=''>
        <div class="flex flex-col gap-6 items-center mt-12">
            <!-- Large Box with Folded Corner Design -->
            <div class="flex flex-col gap-6 relative 7xl h-auto bg-gray-100 rounded-lg shadow-lg border border-gray-300 p-6">
